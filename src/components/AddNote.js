...
const AddNote = () => {
    ...
    return (
        <div className='w-full h-full bg-[#112e42] px-[10rem] py-[5%] flex flex-col items-center justify-center gap-20'>
            <div className='min-h-[40vh] w-[60vw] flex justify-center items-center flex-col gap-6 rounded-lg px-5 z-40 '>
                <div className="min-w-[30vw] w-full mt-40 md:mt-20 mx-auto rounded-2xl p-4 md:p-8 shadow-input bg-transparent z-40 border-red-400 border-2 ">
